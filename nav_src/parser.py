...
# ADD THIS NEW ARGUMENT
    parser.add_argument('--agent_mode', type=str, default='simulator', choices=['simulator', 'robot_dog'], help='The mode for the agent to run in.')
...
def postprocess_args(args):
    ...
    # Setup input paths
    args.obs_dir = os.path.join(ROOTDIR, 'R2R', 'obser_list_summarized')
    args.obs_summary_dir = os.path.join(ROOTDIR, 'R2R', 'obser_summarized')
